...
addon_info = AddonInfo(
	...
	addon_changelog=_("""2.0.0 changes:
- new gestures (old gestures+control) to execute actions without terminating the exploration (experimental);
- compatibility with NVDA 2026.1."""),
	...
	addon_sourceURL="https://github.com/ABuffEr/toolbarsExplorer",
...
pythonSources: list[str] = ["addon/globalPlugins/toolbarsExplorer/__init__.py"]
